...
public class TestController {
	...
	public ResponseEntity<byte[]> showImage(@RequestParam(value = "name") String name) throws IOException {
		 InputStream in = servletContext.getResourceAsStream(this.directory + name);
