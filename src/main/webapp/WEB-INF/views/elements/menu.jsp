<ul class="nav nav-pills nav-stacked">
	...
	<li role="presentation"><a href="/sokrates/admin/about"><span
			class="glyphicon glyphicon-book" aria-hidden="true"></span>&nbsp;&nbsp;About</a></li>
	<li role="presentation"><a
		href="/sokrates/j_spring_security_logout"><span
			class="glyphicon glyphicon-off" aria-hidden="true"></span>&nbsp;&nbsp;Logout</a></li>
</ul>